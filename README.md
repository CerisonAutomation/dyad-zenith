...
> **Zenith build:** this distribution uses one Dyad Agent with the free-first **Zenith Auto** model policy and a curated tool/MCP surface. See [docs/ZENITH.md](docs/ZENITH.md).
