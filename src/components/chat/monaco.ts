...
// Load Monaco from the local npm package instead of the CDN.
// The CDN (cdn.jsdelivr.net) is blocked by our Content-Security-Policy
// (script-src 'self'), which breaks the editor in dev mode.
