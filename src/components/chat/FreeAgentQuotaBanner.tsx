 ...
 * Shows the time until quota resets and provides option to switch modes.
 */
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 space-y-2">
          <p className="text-sm text-amber-700 dark:text-amber-300">
            ...
            today. Check back in {resetTimeDisplay} ({resetDateTime}). Switch
            back to Build mode to continue.
          </p>
