...
export const GuideEntryDtoSchema = z.object({
  slug: z.string(),
  title: z.string(),
  description: z.string(),
});

export type GuideEntryDto = z.infer<typeof GuideEntryDtoSchema>;
...
export const promptContracts = {
  ...
  listGuides: defineContract({
    channel: "prompts:list-guides",
    input: z.void(),
    output: z.array(GuideEntryDtoSchema),
  }),
