...
For large files (>200 lines), use start_line_one_indexed and end_line_one_indexed_inclusive to read only the relevant section. Reading the entire large file wastes context and may cause you to lose track of important details.
