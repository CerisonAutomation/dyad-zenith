...
/**
 * High-level wrapper that delegates broad historical recall to a
...
- An outcome of "no_match" means no relevant prior discussion was found — treat absence as inconclusive and consider asking the user rather than assuming.`,
  ...
  getConsentPreview: (args) =>
    `Research this app's chat history for "${args.query}" using the configured Settings model and provide a summarized, cited report.`,
