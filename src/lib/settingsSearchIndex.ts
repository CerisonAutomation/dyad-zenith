...
export const SETTINGS_SEARCH_INDEX: SearchableSettingItem[] = [
  ...
  // AI Settings
  {
    ...
    description:
      "Control reasoning depth: Low (faster/cheaper), Medium (balanced), High (deeper analysis). Higher budgets give the selected model more room for difficult analysis.",
    keywords: [
      "thinking",
      "tokens",
      "budget",
  ...
  },
  {
    ...
    description:
      "Maximum tool calls per agent turn. Raise this only when a task legitimately needs more evidence, edits, and verification steps.",
    keywords: [
      "tool",
      "calls",
      "max",
  ...
  },
  {
    ...
    description:
      "Automatically compact long conversations when approaching context limits while preserving the most relevant project context.",
    keywords: [
      "context",
      "compaction",
      "compact",
